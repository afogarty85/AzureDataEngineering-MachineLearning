...
def parse_args():
    ...
    parser.add_argument("--batch_size_per_device", type=int, default=448, help="Batch size to use per device.")
    parser.add_argument("--num_devices", type=int, default=1, help="Number of devices to use.")
    parser.add_argument("--num_workers", type=int, default=1, help="Number of workers to use.")    
    parser.add_argument("--seed", type=int, default=1, help="Seed.") 
    parser.add_argument("--dim_model", type=int, default=640, help="The dimensionality of the input embeddings and model") 
    parser.add_argument("--num_heads", type=int, default=4, help="Number of attention heads.") 
    parser.add_argument("--dim_feedforward", type=int, default=1792, help="The dimensionality of the feedforward network model in the Transformer encoder  ") 
    parser.add_argument("--n_layers", type=int, default=6, help="Number of attention heads.") 
    parser.add_argument("--activation_function", type=str, default='relu', help="Activation fn for transformer block.") 
    parser.add_argument("--mlp_hidden_layers", nargs='+', type=int, default=[256, 512, 768], help="MLP feature transformer")
    ...
    parser.add_argument("--lr", type=float, default=0.00097, help="Learning rate to use.")
...
EMBEDDING_TABLE_SHAPES = {'FaultCode': (284, 25),
                          'DiscreteSkuMSFId': (1202, 25),
                          'RobertsRules': (3632, 25),
                          'Cluster': (9872, 25),
                          'TopFCHops': (180, 25),
                          'ClusterLabel': (123, 25),
                          'FCMSFRepair': (1422, 25),
...
def train_loop_per_worker(config):
    ...
    # Load Datasets
    # ====================================================
    train_set_df = pd.read_parquet('/mnt/c/Users/afogarty/Desktop/AZRepairRL/data/seq_azrepair_train.parquet')
    test_set_df = pd.read_parquet('/mnt/c/Users/afogarty/Desktop/AZRepairRL/data/seq_azrepair_test.parquet')  
